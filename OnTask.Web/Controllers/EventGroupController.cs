...
{
    /// <summary>
    /// Provides API methods related to event group data.
    /// </summary>
    [Route("api/[controller]")]
    public class EventGroupController : BaseAuthenticatedController
    {
        #region Fields
        private readonly IEventGroupService service;
        #endregion

        #region Initialization
        /// <summary>
        /// Initializes a new instance of the <see cref="EventGroupController"/> class.
        /// </summary>
        /// <param name="httpContextAccessor">The class that provides <see cref="HttpContext"/> data.</param>
        /// <param name="service">The service for interacting with event group data.</param>
        ...
        /// <summary>
        /// Creates an <see cref="EventGroupModel"/> class.
        /// </summary>
        ...
        /// </summary>
        /// <param name="model">The model that provides data on which <see cref="EventGroupModel"/> classes to delete.</param>
        /// <returns>An <see cref="IActionResult"/> response.</returns>
        ...
        [ProducesResponseType(201)]
        [ProducesResponseType(400)]
        public IActionResult DeleteMultiple([FromBody]EventGroupDeleteMultipleModel model)
        {
            if (ModelState.IsValid)
            {
        ...
        /// <summary>
        /// Gets all <see cref="EventGroupModel"/> classes.
        /// </summary>
        /// <param name="model">The model that provides data on which <see cref="EventGroupModel"/> classes to get.</param>
        /// <returns>An <see cref="IActionResult"/> response containing the <see cref="EventGroupModel"/> classes.</returns>
        ...
        /// <returns>An <see cref="IActionResult"/> response containing the <see cref="EventGroupModel"/> class.</returns>
        ...
        /// </summary>
        /// <param name="id">The identifier for the <see cref="EventGroupModel"/> class to update.</param>
